...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Call the database function to get live results
    const { data, error } = await supabase.rpc("get_ag_live_results", {
      p_ag_id: agId,
    });
    ...
    // Add cache control headers for polling optimization
