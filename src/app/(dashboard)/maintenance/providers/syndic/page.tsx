        ...
        <div className="container">
            ...
            <div className={styles.header}>
                <div className={styles.headerLeft}>
                    ...
                    <div>
                        <h1 className={styles.title}>Prestataires du syndic</h1>
                        <p className={styles.subtitle}>
                            Base interne de prestataires de confiance ({filteredAndSortedPrestataires.length})
                        </p>
                    </div>
                </div>
                <div className={styles.actions}>
                    <button className="btn btn-primary" onClick={() => router.push('/maintenance/providers?add=syndic')}>
