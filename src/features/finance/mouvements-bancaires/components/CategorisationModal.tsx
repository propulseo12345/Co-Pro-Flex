...
export function CategorisationModal({
  ...
  const comptesCharge = PLAN_COMPTABLE_ESSENTIEL.filter(c => c.categorie === 'charge');
  const comptesProduit = PLAN_COMPTABLE_ESSENTIEL.filter(c => c.categorie === 'produit');
            ...
            {selectedCategorie && (
              <div className={styles.formGroup}>
                ...
                >
                  ...
                  {(selectedCategorie === 'charge' ? comptesCharge : comptesProduit).map((compte) => (
